...
2) Cosa ho modificato nei file di opennn? Cos'è testing_analysis?
	...
	Ha senso inserire la funzione che calcola l'output multidimensionale a partire da 	quello della rete anche in Testing_analysis? (E' giˆ presente in normalized 		squared error) 
